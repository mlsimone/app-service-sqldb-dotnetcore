...
if (builder.Environment.IsDevelopment())
{
    ...
    azure_connection_string = builder.Configuration.GetConnectionString("AZURE_SQL_CONNECTIONSTRING-password");
}
else
{
    // get from Environment
    azure_connection_string = builder.Configuration.GetConnectionString("AZURE_SQL_CONNECTIONSTRING-managedId"); //Environment.GetEnvironmentVariable("AZURE_SQL_CONNECTIONSTRING");
}
